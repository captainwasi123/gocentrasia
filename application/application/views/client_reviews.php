                    ...
                    <div class="col-lg-12 col-12 m-t-35" style="margin-top: 0px !important;">
                            <div class="card">
                                <div class="card-header bg-white">
                                    <h5><?=$form_title?></h5>
                                     <form action="<?php echo site_url('Pages/save_client_reviews'); ?>" id="add_product" method="post" enctype="multipart/form-data">
                                <div class="card-block">
                                    <div class="row">
                                        <div class="col-lg-6 input_field_sections">
                                            <h5>Client Name<span style="color: #F00">*</span></h5>
                                            <input type="text" class="form-control" name="name"
                                            placeholder="Enter Client Name" autocomplete="off" required/>
                                        </div>
										<div class="col-lg-6 input_field_sections">
                                            <h5>Client Image<span style="color: #F00">*</span></h5>
                                            <input type="file" class="form-control" name="img"
                                            autocomplete="off"/>
                                        </div>
                                        <div class="col-lg-12 input_field_sections">
                                            <h5>Review<span style="color: #F00">*</span></h5>
											<textarea class="form-control" name="review" id="" cols="40" rows="3" required placeholder="Enter Review"></textarea>
                                        </div> 
                                    </div>
                                       ...
                                       <tbody>
                                        <?php foreach ($review as $key => $value) { ?>
                                            <tr>
                                                ...
                                                <td><?=$value->name?></td>
												<td>
													<img class="img-thumbnil" src="<?=base_url()?>assets/img/client_img/<?=$value->img?>" alt="">
												</td>
												<td><?=$value->review?></td>	
                                                <td>
													<form action="<?=base_url();?>Pages/delete_client_reviews" method="post">
