                    ...
                    <div class="col-lg-12 col-12 m-t-35" style="margin-top: 0px !important;">
                            <div class="card">
                                <div class="card-header bg-white">
                                    <h5><?=$form_title?></h5>
                                    <form action="<?=base_url();?>Blog/save_blog" method="POST" id="add_package" enctype="multipart/form-data">
                                <div class="card-block">
                                    ...
                                    <div class="row">
										...
										<div class="col-6 input_field_sections">
											...
											<input class="form-control" type="text" name="link" id="day" placeholder="Enter Video Link" required>
										</div>
                                    </div>
									<div class="row">
                                        <div class="col-6 input_field_sections">
                                    ...
                                    <div class="row">
                                        <div class="col-12 input_field_sections">
											...
											<textarea class="form-control" type="text" id="description" name="description" placeholder="Enter Description" required></textarea>
										</div>
                                    </div>
                                    <br>
