                                       ...
                                       <tbody>
                                        <?php foreach ($data as $key => $value) { ?>
                                            <tr>
                                                ...
                                                <td><img src="<?=base_url();?><?=$value->country_img?>" width='100px'></td>
                                                <td>
													<a id="editBtn" class="btn btn-info btn-sm" href="<?=base_url();?>Dashboard/edit_counrty/<?=hashids_encrypt($value->id)?>">Edit</a>
                                                    <form action="<?=base_url();?>Dashboard/delete_country" method="post">
                                                        <input type="hidden" name="id" value="<?=$value->id?>">
                                                        <input type="hidden" name="c_img" value="<?=$value->country_img?>">
