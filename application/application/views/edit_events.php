                    ...
                    <div class="col-lg-12 col-12 m-t-35" style="margin-top: 0px !important;">
                            <div class="card">
                                <div class="card-header bg-white">
                                    <h5><?=$form_title?></h5>
                                     <form action="<?php echo site_url('Dashboard/update_event'); ?>" id="add_product" method="post" enctype="multipart/form-data">
                                <div class="card-block">
                                    ...
                                    <?php foreach($edit_data as $row) { ?>
                                        ...
                                        <div class="col-lg-6 input_field_sections">
                                            ...
                                            <input type="text" class="form-control" name="event_name" value="<?=$row->event_name?>" required />
                                        </div> 
                                        ...
                                        <div class="col-lg-6 input_field_sections">
                                            <h5>Duration</h5>
                                            <input type="text" class="form-control" name="duration" id="duration" readonly="" value="<?=$row->duration?>">
                                        </div>
                                        
                                        <div class="col-lg-3 input_field_sections">
                                            <h5>Start Date<span style="color: #F00">*</span></h5>
                                            <input type="text" class="form-control" name="start_date" value="<?=get_date($row->start_date, 'Y-m-d')?>" required />
                                        </div> 
                                       
                                        <div class="col-lg-3 input_field_sections">
                                            <h5>End Date<span style="color: #F00">*</span></h5>
                                            <input type="text" class="form-control" name="end_date" value="<?=get_date($row->end_date, 'Y-m-d')?>" required />
                                        </div>
                                        <div class="col-lg-3 input_field_sections">
                                            <h5>GST<span style="color: #F00">*</span></h5>
                                            <input type="text" class="form-control" id="gst" name="gst"
                                            placeholder="Enter GST" value="<?=$row->gst?>" autocomplete="off" required/>
                                        </div>
										<div class="col-lg-3 input_field_sections">
                                            <h5>TCS<span style="color: #F00">*</span></h5>
                                            <input type="text" class="form-control" id="tcs" name="tcs"
                                            placeholder="Enter TCS" value="<?=$row->tcs?>" autocomplete="off" required/>
                                        </div>
										<div class="col-lg-3 input_field_sections">
                                            <h5>Min People<span style="color: #F00">*</span></h5>
                                            <input type="text" class="form-control" name="min_no_people"
                                            placeholder="Min No: of People In Group" autocomplete="off" min="2" max="16" required value="<?=$row->min_no_people?>"/>
                                        </div>
										<div class="col-lg-3 input_field_sections">
                                            <h5>Max People<span style="color: #F00">*</span></h5>
                                            <input type="text" class="form-control" name="max_no_people"
                                            placeholder="Max No: People In Group" min="2" max="16" autocomplete="off" value="<?=$row->max_no_people?>" required/>
                                        </div>
										<div class="col-lg-3 input_field_sections">
                                            <h5>Separate Room Sharges<span style="color: #F00">*</span></h5>
                                            <input type="text" class="form-control" name="separate_room_charges"
                                            placeholder="Enter Seperate Room Charges" value="<?=$row->separate_room_charges?>" autocomplete="off" required/>
                                        </div>
										<div class="col-lg-3 input_field_sections">
                                            <h5>Affiliate code<span style="color: #F00">*</span></h5>
                                            <input type="text" class="form-control" name="affiliate_code"
                                            placeholder="Enter Affiliate code" value="<?=$row->affiliate_code?>" autocomplete="off" required/>
                                        </div>
										
                                        <div class="col-lg-3 input_field_sections">
                                            <h5>Group Tour Price (INR)<span style="color: #F00">*</span></h5>
                                            <input type="text" class="form-control" id="group_price" name="group_price"
                                            placeholder="Enter Group Tour Price" value="<?=$row->group_price?>" autocomplete="off" required/>
                                        </div>
                                        <div class="col-lg-3 input_field_sections">
                                            ...
                                            placeholder="Enter Private Tour Price" value="<?=$row->private_price?>" autocomplete="off" required/>
                                        </div>
										<div class="col-lg-3 input_field_sections">
                                            <h5>Affiliate code Discount<span style="color: #F00">*</span></h5>
                                            <input type="text" class="form-control" name="discount"
                                            placeholder="Enter Affiliate code Discount" value="<?=$row->discount?>" autocomplete="off" required/>
                                        </div>
										<div class="col-lg-3 input_field_sections">
                                            <h5>Group Price with Txt<span style="color: #F00">*</span></h5>
                                            <input type="text" class="form-control" id="group_txt_price" name="group_txt_price" autocomplete="off" value="<?=$row->group_txt_price?>" readonly="" required/>
                                        </div>
										<div class="col-lg-3 input_field_sections">
                                            <h5>Private Price with Txt<span style="color: #F00">*</span></h5>
                                            <input type="text" class="form-control" id="private_txt_price" name="private_txt_price"  autocomplete="off" value="<?=$row->private_txt_price?>" readonly="" required/>
                                        </div>
										<div class="col-lg-3 input_field_sections">
