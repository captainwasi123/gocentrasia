                                       ...
                                       <tbody>
                                        <?php foreach ($data as $key => $value) { ?>
                                            <tr>
                                                ...
                                                <td><?=$value->cName?></td>
                                                <td><img class="img img-thumbnail" width="100" src="<?=base_url()?><?=$value->images?>" alt=""></td>
                                                <td>
                                                    <a class="btn btn-info btn-sm" href="<?=base_url();?>Dashboard/view_package/<?=hashids_encrypt($value->id)?>"><i class="fa fa-eye"></i></i></a>
                                                    <!-- <a id="editBtn" class="btn btn-info btn-sm" href="<?=base_url();?>Dashboard/edit_package/<?=hashids_encrypt($value->id)?>">Edit</a>
                                                    <a class="btn btn-danger btn-sm" href="<?=base_url();?>Dashboard/delete_package/<?=hashids_encrypt($value->id)?>"><i class="fa fa-trash"></i></i></a> -->
                                                </td>
                                            </tr>
                                        <?php } ?>    
                                       </tbody>
