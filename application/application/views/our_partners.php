                    ...
                    <div class="col-lg-12 col-12 m-t-35" style="margin-top: 0px !important;">
                            <div class="card">
                                <div class="card-header bg-white">
                                    <h5><?=$form_title?></h5>
                                     <form action="<?php echo site_url('Pages/save_our_partners'); ?>" id="add_product" method="post" enctype="multipart/form-data">
                                <div class="card-block">
                                    <div class="row">
                                        <div class="col-lg-4 input_field_sections">
                                            <h5>Partner Image<span style="color: #F00">*</span></h5>
                                   ...
                                   <table class="table table-striped table-bordered table-hover " id="sample_6">
                                       ...
                                       <tbody>
                                        <?php foreach ($partners as $key => $value) { ?>
                                            <tr>
                                                <td><?=++$key?></td>
                                                <td><img class="img-thumbnil" src="<?=base_url()."assets/img/partners_logo/"?><?=$value->img?>"></td>	
                                                <td>
													<form action="<?=base_url();?>Pages/delete_our_partners" method="post">
