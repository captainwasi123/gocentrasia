                    ...
                    <div class="col-lg-12 col-12 m-t-35" style="margin-top: 0px !important;">
                            <div class="card">
                                <div class="card-header bg-white">
                                    <h5><?=$form_title?></h5>
                                     <form action="<?php echo site_url('Dashboard/save_country'); ?>" id="add_product" method="post" enctype="multipart/form-data">
                                <div class="card-block">
                                    <div class="row">
                                        <div class="col-lg-6 input_field_sections">
                                            <h5>Country Name<span style="color: #F00">*</span></h5>
                                            <input type="text" class="form-control" name="country_name"
                                            placeholder="Enter Country Name" autocomplete="off" required/>
                                        </div>
                                        <div class="col-lg-6 input_field_sections">
                                            <h5>Tag Line<span style="color: #F00">*</span></h5>
                                            <input type="text" class="form-control" name="tag_line"
                                            placeholder="Enter tag Line" autocomplete="off" required/>
                                        </div>
                                    </div>
									...
									<div class="row">
                                        <div class="col-lg-6 input_field_sections">
                                            ...
                                            placeholder="Enter Latitude Of Country" autocomplete="off" required/>
                                        </div>
                                        <div class="col-lg-6 input_field_sections">
                                            <h5>Longitude Of Country<span style="color: #F00">*</span></h5>
                                            <input type="text" class="form-control" name="longitude"
                                            placeholder="Enter Longitude Of Country" autocomplete="off" required/>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-6 input_field_sections">
                                            <h5>Tour<span style="color: #F00">*</span></h5>
                                            <input type="text" class="form-control" name="tour" placeholder="Enter Tour detail" required />
                                        </div>
                                        <div class="col-lg-6 input_field_sections">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 input_field_sections">
                                            <h5>Main Image<span style="color: #F00">*</span></h5>
                                            <input type="file" class="form-control" name="img"
                                            autocomplete="off" required/>
                                        </div> 
                                        <div class="col-lg-6 input_field_sections">
                                            <h5>Gallery<span style="color: #F00">*</span></h5>
                                            <input type="file" class="form-control" name="country_gallery[]" multiple required />
                                        </div>
                                         <div class="col-lg-6 input_field_sections">
                                            <h5>Show in Website<span style="color: #F00">*</span></h5>
                                           <div class="col-lg-10">
                                                <label class="custom-control custom-radio signin_radio1">
                                                    <input id="radio" name="show_on_website" type="radio" value="1" class="custom-control-input">
                                                    <span class="custom-control-indicator"></span>
                                                    <span class="custom-control-description">Yes</span>
                                                </label>
                                                <label class="custom-control custom-radio signin_radio2">
                                                    <input id="radio2" name="show_on_website" type="radio" class="custom-control-input" value="0" checked="">
                                                    <span class="custom-control-indicator"></span>
                                    ...
                                    <div class="row">
                                        <div class="col-12 input_field_sections">
                                            <h5>Description<span style="color: #F00">*</span></h5>
