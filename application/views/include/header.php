        ...
        <div id="left">
            <div class="menu_scroll">
                ...
                <ul id="menu">
					...
					<li class="dropdown_menu <?php if($tk_c == 'dashboard' && $tk_m == 'city' || $tk_m == 'add_city'){ echo 'active'; }?> ">
                        <a href="javascript:;">
                            <!-- <i class="fa fa-user"></i> -->
                            <i class="fa fa-building"></i>
                            <span class="link-title menu_hide">&nbsp; City</span>
                            <span class="fa arrow menu_hide"></span>
                        </a>
                        <ul>
                            <li class="<?php if($tk_m == 'city'){echo 'active';}?>">
                                <a href="<?=base_url();?>dashboard/city">
                                    <i class=""></i>
                                    &nbsp; All City
                                </a>
                            </li>
                            <li class="<?php if($tk_m == 'city_add'){echo 'active';}?>">
                                <a href="<?=base_url();?>dashboard/city_add">
                                    <i class=""></i>
                                    &nbsp; Add City 
                                </a>
                            </li>
					...
					<li class="<?php if($tk_c == 'dashboard' && $tk_m == 'guide_details'){ echo 'active';} ?>">
                        <a href="<?php echo site_url('dashboard/guide_details'); ?>">
                            <i class="fa fa-male"></i>
                            <span class="link-title menu_hide">&nbsp;Guide Details</span>
                        </a>
                    </li>
					<li class="dropdown_menu <?php if($tk_c == 'dashboard' && $tk_m == 'arrival_city' || $tk_m == 'departure_city'){ echo 'active'; }?> ">
                        <a href="javascript:;">
                            <i class="fa fa-building"></i>
                            <span class="link-title menu_hide">&nbsp; Arrival And Departure City</span>
                            <span class="fa arrow menu_hide"></span>
                        </a>
                        <ul>
                            <li class="<?php if($tk_m == 'arrival_city'){echo 'active';}?>">
							<a href="<?php echo site_url('dashboard/arrival_city'); ?>">
								<span class="link-title menu_hide">&nbsp;Arrival City</span>
							</a>
                            </li>
                            <li class="<?php if($tk_m == 'departure_city'){echo 'active';}?>">
                                <a href="<?=base_url();?>dashboard/departure_city">
                                	<span class="link-title menu_hide"> &nbsp;Departure City  </span>
                                </a>
                            </li>
                        </ul>
                    </li>

					<li class="dropdown_menu <?php if($tk_c == 'dashboard' && $tk_m == 'agent_size_cost' || $tk_m == 'agent_size_cost_all'){ echo 'active'; }?> ">
                        <a href="javascript:;">
                            <i class="fa fa-building"></i>
                            <span class="link-title menu_hide">&nbsp; Aggent Rates And Group Size </span>
                            <span class="fa arrow menu_hide"></span>
                        </a>
                        <ul>
							<li class="<?php if($tk_c == 'dashboard' && $tk_m == 'agent_size_cost'){ echo 'active';} ?>">
								<a href="<?php echo site_url('dashboard/agent_size_cost'); ?>">
									<i class="fa fa-flag"></i>
									<span class="link-title menu_hide">&nbsp;Add Aggent Rates</span>
								</a>
							</li>
							<li class="<?php if($tk_c == 'dashboard' && $tk_m == 'agent_size_cost_all'){ echo 'active';} ?>">
								<a href="<?php echo site_url('dashboard/agent_size_cost_all'); ?>">
									<i class="fa fa-flag"></i>
									<span class="link-title menu_hide">&nbsp;All Aggent Rates</span>
								</a>
							</li>
                        </ul>
                    </li>
                    ...
                    <li class="dropdown_menu <?php if($tk_c == 'Pages' && $tk_m == 'client_reviews' || $tk_m == 'our_partners' || $tk_m == 'home' || $tk_m == 'slider' || $tk_m == 'about_us' || $tk_m == 'terms_and_conditions'){ echo 'active'; }?> ">
						...
						<li class="<?php if($tk_c == 'dashboard' && $tk_m == 'website_setting'){ echo 'active';} ?>">
							<a href="<?php echo site_url('dashboard/website_setting'); ?>">
								<i class="fa fa-cog"></i>
								<span class="link-title menu_hide">&nbsp;Website Setting</span>
							</a>
                    	</li>
				 </ul>
                <!-- /#menu -->
