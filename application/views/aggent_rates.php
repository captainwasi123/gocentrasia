								...
								<div class="row">
                                    <div class="col-lg-6 input_field_sections">
										...
										<div class="col-lg-6 input_field_sections">
                                            ...
                                            <input type="text" class="form-control" name="country" id="country" readonly autocomplete="off" required/>
                                        </div>
                                    </div>
                                    <div class="row">
										<div class="col-lg-6 input_field_sections">
										...
										<div class="col-lg-6 input_field_sections" id="show_tour_type">
										...
										<div class="col-lg-3 input_field_sections d-none" id="show_group">
									...
									<div class="row mt-3 d-none" id="private_table">
										<div class="col-12">
									...
									<div class="row mt-3 d-none" id="group_table">
										<div class="col-12">
    ...
    var i=7;  
       $('#add').click(function(){  
           ...
           $('#addrow').append('<tr class="dynamic_row" id="row'+i+'">\n\
                                                    <td>\n\
													<input id="price0" type="number" class="form-control groups_size" name="groups_size['+i+']"		placeholder="Enter (group size)" />\n\
                                                   </td>\n\
                                                    <td>\n\
														<input id="subtotal0" type="number" placeholder="Enter Cost per person" class="form-control group_price subtotal" name="group_price['+i+']" />\n\
                                                   </td>\n\
