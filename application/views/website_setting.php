                    ...
                    <div class="col-lg-12 col-12 m-t-35" style="margin-top: 0px !important;">
                            <div class="card">
                                <div class="card-header bg-white">
                                    <h5><?=$form_title?></h5>
                                     <form action="<?php echo site_url('Dashboard/save_settings'); ?>" id="add_product" method="post" enctype="multipart/form-data">
                                <div class="card-block">
                                    <div class="row">
                                        <div class="col-lg-4 input_field_sections">
                                            <h5>Basefare<span style="color: #F00">*</span></h5>
                                            <input type="number" class="form-control" name="basefare"
                                            placeholder="Enter Basefare" value="<?=$data->basefare?>" autocomplete="off" required/>
                                        </div>
                                        <div class="col-lg-4 input_field_sections">
                                            <h5>General Sales Tax<span style="color: #F00">*</span></h5>
                                            <input type="number" class="form-control" name="gst"
                                            placeholder="Enter GST" autocomplete="off" value="<?=$data->gst?>" required/>
                                        </div>
										<div class="col-lg-4 input_field_sections">
                                            <h5>Tax Collected Source<span style="color: #F00">*</span></h5>
                                            <input type="number" class="form-control" name="tcs"
                                            placeholder="Enter TCS" autocomplete="off" value="<?=$data->tcs?>" required/>
                                        </div>
                                    </div>
									<br>
