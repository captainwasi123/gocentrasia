                                       ...
                                       <tbody>
                                        <?php foreach ($tour as $key => $value) { ?>
                                            <tr>
                                                ...
                                                <td><?=$value->title?></td>
                                                <td><?=$value->day?></td>
                                                <td><?=substr($value->description,-20)?></td>
                                                <td><?=substr($value->place,-20)?></td>
                                                <!-- <td><?=substr($value->mausoleum,-20)?></td> -->
                                                <td><?=$value->price?></td>
                                                <td><img class="img img-thumbnail" src="<?=base_url()?><?=$value->image?>" alt=""></td>
                                                <td>
                                                    <a id="editBtn" class="btn btn-info btn-sm" href="<?=base_url();?>custom_tour/edit_custom_tour/<?=hashids_encrypt($value->id)?>">Edit</a>
                                                    <a class="btn btn-danger btn-sm" href="<?=base_url();?>custom_tour/deletecustom/<?=hashids_encrypt($value->id)?>"><i class="fa fa-trash"></i></i></a>
                                                </td>
                                            </tr>
                                        <?php } ?>    
                                       </tbody>
