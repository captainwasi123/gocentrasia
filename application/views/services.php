                    ...
                    <div class="col-lg-12 col-12 m-t-35" style="margin-top: 0px !important;">
                            <div class="card">
                                <div class="card-header bg-white">
                                    <h5><?=$form_title?></h5>
                                     <form action="<?php echo site_url('Dashboard/save_service'); ?>" id="add_product" method="post" enctype="multipart/form-data">
                                <div class="card-block">
                                    <div class="row">
                                        <div class="col-lg-6 input_field_sections">
                                            <h5>Service Name</h5>
                                            <input type="text" class="form-control" name="service_name"
                                            placeholder="Enter Service Name" autocomplete="off" required/>
                                        </div>
                                        <div class="col-lg-6 input_field_sections">
                                        ...
                                        <?php foreach ($data as $key => $value) { ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <form action="<?=base_url();?>Dashboard/delete_service" method="post">
                                                        <input type="hidden" name="act_img" value="<?=$value->service_img?>">
