...
<section class="tajiskistan-bg country-banner">
         <div class="container">
            <div class="banner-text2">
               <h3> Discovered Tajiskistan </h3>
            ...
            <div class="row">
               <div class="col-md-9 col-lg-9 col-sm-12 col-xs-12">
                  ...
                  <div class="country-textual2">
                     <div> <img src="<?=base_url()."assets/site/"?>images/tajiskistan-image1.jpg"> </div>
                     <div> <img src="<?=base_url()."assets/site/"?>images/tajiskistan-image2.jpg"> </div>
                     <div> <img src="<?=base_url()."assets/site/"?>images/tajiskistan-image3.jpg"> </div>
                  </div>
               </div>
            ...
            <div class="package-data">
               <div class="row">
                  <div class="col-md-4 col-lg-4 col-sm-6 col-xs-12">
                     <div class="package-box2">
                        <div class="package-box2-image">
                           <img src="<?=base_url()."assets/site/"?>images/tajiskistan-tour1.jpg">
                  ...
                  <div class="col-md-4 col-lg-4 col-sm-6 col-xs-12">
                     <div class="package-box2">
                        <div class="package-box2-image">
                           <img src="<?=base_url()."assets/site/"?>images/tajiskistan-tour2.jpg">
                           <h4> Tour to Turkmenistan </h4>
                        </div>
                        <div class="package-box2-middle">
                           <p> Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempordolore magna aliqua. Quis ipsum suspendisse ultrices gravida. Risus commodo viverra maecenas accumsan lacus vel facilisis.  </p>
                  ...
                  <div class="col-md-4 col-lg-4 col-sm-6 col-xs-12">
                     <div class="package-box2">
                        <div class="package-box2-image">
                           <img src="<?=base_url()."assets/site/"?>images/tajiskistan-tour3.jpg">
