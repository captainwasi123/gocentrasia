                                       ...
                                       <tbody>
                                            <?php foreach ($city as $key => $value) { ?>
                                                <tr>
                                                    ...
                                                    <td><?=$value->name?></td>
                                                    <td>
                                                        <a id="editBtn" class="btn btn-info btn-sm" href="<?=base_url();?>Dashboard/edit_city/<?=hashids_encrypt($value->id)?>">Edit</a>
														<a id="editBtn" class="btn btn-danger btn-sm" href="<?=base_url();?>Dashboard/delete_city/<?=hashids_encrypt($value->id)?>"><i class="fa fa-trash"></i></a>
                                                    </a>
                                                    </td>
                                                </tr>
                                            <?php } ?>
