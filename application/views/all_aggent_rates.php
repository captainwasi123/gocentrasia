                                       ...
                                       <tbody>
											<?php foreach ($data as $key => $value) { ?>
												<tr>
													...
													<td>
														<a class="btn btn-primary btn-sm" href="<?=base_url();?>Dashboard/agent_size_cost_view/<?=hashids_encrypt($value->id)?>">
															<i class="fa fa-eye"></i>
														</a>
														<a id="editBtn" class="btn btn-info btn-sm" href="<?=base_url();?>Dashboard/agent_size_cost_edit/<?=hashids_encrypt($value->id)?>">Edit</a>
														<a class="btn btn-danger btn-sm mt-1" href="<?=base_url();?>Dashboard/delete_agent_size_cost/<?=hashids_encrypt($value->id)?>"><i class="fa fa-trash"></i></i></a>
                                                	</td>
												</tr>
											<?php } ?>
                                       </tbody>
