                    ...
                    <div class="col-lg-12 col-12 m-t-35" style="margin-top: 0px !important;">
                            <div class="card">
                                <div class="card-header bg-white">
                                    <h5><?=$form_title?></h5>
                                     <form action="<?php echo site_url('Dashboard/update_city'); ?>" id="add_product" method="post" enctype="multipart/form-data">
                                ...
                                <div class="card-block">
                                    <div class="row">
                                        <div class="col-lg-6 input_field_sections">
											...
											<select class="form-control" name="country" id="" required>
												<?php foreach ($data as $key => $value) { ?>
													...
													<?php if ($city->country_id == $value->id) {
														echo "Selected";
													} ?>
                                        ...
                                        <div class="col-lg-6 input_field_sections">
                                            ...
                                            placeholder="Enter City Name" value="<?=$city->name?>" 
									...
									<div class="row">
                                        <div class="col-lg-6 input_field_sections">
                                            ...
                                            placeholder="Enter Latitude Of City" value="<?=$city->latitude?>" autocomplete="off" required/>
                                        </div>
                                        <div class="col-lg-6 input_field_sections">
                                            <h5>Longitude Of City<span style="color: #F00">*</span></h5>
                                            <input type="text" class="form-control" name="longitude"
                                            placeholder="Enter Longitude Of City" value="<?=$city->longitude?>" autocomplete="off" required/>
                                        </div>
                                    </div>
