                    ...
                    <div class="col-lg-12 col-12 m-t-35" style="margin-top: 0px !important;">
                            <div class="card">
                                <div class="card-header bg-white">
                                    <h5><?=$form_title?></h5>
                                     <form action="<?php echo site_url('Pages/save_terms_and_conditions'); ?>" id="add_product" method="post" enctype="multipart/form-data">
                                <div class="card-block">
                                    <div class="row">
                                        <div class="col-lg-6 input_field_sections">
                                            <h5>Title</h5>
                                            <input type="text" class="form-control" name="title" autocomplete="off" value="<?=@$form_data->title?>" required/>
                                        </div>
                                        <div class="col-lg-6 input_field_sections">
                                            <h5>Description<span style="color: #F00">*</span></h5>
                                            <textarea class="form-control" name="description" required="" rows="6"><?=@$form_data->description?></textarea>
                                        </div> 
                                    </div>
                                       ...
                                       <tbody>
                                        <?php foreach ($data as $key => $value) { ?>
                                            <tr>
                                                ...
                                                <td>
													<a id="editBtn" class="btn btn-info btn-sm" href="<?=base_url();?>pages/edit_terms_and_conditions/<?=hashids_encrypt($value->id)?>">Edit</a>
                                        		</td>
                                            </tr>
                                        <?php } ?>    
                                       </tbody>
