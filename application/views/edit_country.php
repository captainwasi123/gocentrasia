									...
									<div class="col-lg-6 input_field_sections">
										...
										<div class="col-lg-10">
											<label class="custom-control custom-radio signin_radio1">
												<input id="radio" name="show_on_website" type="radio" value="1" 
												<?php if ($country->show_on_website == 1) { ?>
													checked
												<?php } ?>
											...
											<label class="custom-control custom-radio signin_radio2">
												<input id="radio2" name="show_on_website" type="radio" class="custom-control-input" value="0" 
												<?php if ($country->show_on_website == 0) { ?>
													checked
												<?php } ?>
												>
												<span class="custom-control-indicator"></span>
